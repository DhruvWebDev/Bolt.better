    ...
    <header className="border-b border-zinc-800 bg-black">
      <nav className="container mx-auto py-4 px-4 flex justify-between items-center">
        <Link href="/" className="flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 51 21.9" className="h-8 w-auto fill-current text-white">
        ...
        <div className="flex items-center gap-4">
          <SignedOut>
            <SignInButton forceRedirectUrl={process.env.NEXT_PUBLIC_CLERK_REDIRECT_URL} fallbackRedirectUrl={process.env.NEXT_PUBLIC_CLERK_REDIRECT_URL}>
