...
//Why Use stripIndents?
//To clean up strings defined with inconsistent indentation, especially in template literals.
//Useful in scenarios like logging, testing, or preparing formatted output for display.
